...
<?php
  ...
  $registros = mysqli_query($conexion, "select Id from trabajos where Id='$_REQUEST[ID]'") or
    die("Problemas en el select:" . mysqli_error($conexion));
  if ($Reg = mysqli_fetch_array($registros)) {
    mysqli_query($conexion, "delete from trabajos where Id ='$_REQUEST[ID]'") or
      die("Problemas en el select:" . mysqli_error($conexion));
    ?>
	<img src="imagenes/Palomita.png" width="120" height="100"><br>
    <h2>trabajo eliminado</h2>
	<?php
  } else {
    ?>
...
?>
<br><br>
  <a href="ElimTrabajo.php"><input type="submit" value="Regresar"></a>
</div>
</body>